...
class biller: UIViewController, UITableViewDelegate,UITableViewDataSource, MFMailComposeViewControllerDelegate {
   ...
   ///////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    func alert5(){
        let alertController5 = UIAlertController(title: ("Bill Recovery") , message: "Do you want to recover the original bill generated by  WalkWalk and send it to you?", preferredStyle: .alert)
